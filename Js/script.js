...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    ...
    \n\nDesde el primer momento supe que eras tú. Tu sonrisa, tu voz, tu forma de ser… todo en ti me hace sentir tan seguro.
    \n\nGracias por todos los momentos felices que paso a tu lado y por llenar mis días de amor.
    \n\nTe amo de aqui hasta el eterno infinito.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Chiclecito";
...
function showCountdown() {
  ...
  let startDate = startParam ? new Date(startParam + 'T00:00:00') : new Date('2022-06-24:00:00'); 
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2025-09-24:00:00');
